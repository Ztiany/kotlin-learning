...
private val retrofit = Retrofit.Builder().apply {
    baseUrl("http://" + explore.retrofit.MockServer.ROOT + ":" + explore.retrofit.MockServer.PORT)
    client(okHttpClient)
    addConverterFactory(explore.retrofit.ErrorJsonLenientConverterFactory(GsonConverterFactory.create()))
