...
fun main() = runBlocking<Unit> {
    // coroutine -- fast producer of elements in the context of the me.ztiany.tools.main thread
    ...
    delay(2000) // suspend the me.ztiany.tools.main thread for a few seconds
}